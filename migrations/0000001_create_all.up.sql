...
INSERT INTO t_user(sname, name, pname,is_active,is_admin,is_member, create_date, file_object_id,email,password) VALUES('Тестирующий','Тест','Тестов',true,true,true,'2022-04-01',3,'test1@yandex.ru','pass'),('Ломающий','Лом','Ломов',true,false,false,'2022-03-01',4,'test2@yandex.ru','pass');
